...
np.savetxt('al_grad.dat',np.array((L,Ag['TT'],Ag['TE'],Ag['TB'],Ag['EE'],Ag['EB'])).T)
...
# save
np.savetxt('cl_grad.dat',np.array((L,gg['TT'],gg['TE'],gg['TB'],gg['EE'],gg['EB'])).T)
np.savetxt('cl_curl.dat',np.array((L,cc['TT'],cc['TE'],cc['TB'],cc['EE'],cc['EB'])).T)
