...
!*
  !f2py intent(in) cmmodel, pktype, cltype, lmax, zn, kn, zs, z, dz, dNdz, k, pk0, wdel
  !f2py intent(out) cl
...
!*
  !f2py intent(in) shap, cpmodel, model, pktype, ltype, btype, z, dz, zs, lmin, lmax, zn, kn, lan, kan, dNdz, k, pk0, wdel
...
!*
  !f2py intent(in) shap, cpmodel, model, pktype, btype, z, dz, zs, lmin, lmax, zn, bn, kn, lan, kan, dNdz, k, pk0, wdel
...
!*
  !f2py intent(in) cpmodel, model, pktype, btype, z, dz, zs, lmin, lmax, zn, kn, ro, lan, kan, dNdz, k, pk0, cl, cgg, wdel
  !f2py intent(out) snr
