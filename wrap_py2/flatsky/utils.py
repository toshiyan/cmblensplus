...
def alm2bcl(bn,oL,nx,ny,D,alm1,alm2=None,spc=None):
  """
...
def c2d2bcl(nx,ny,D,c2d,bn,oL,spc=None):
  """
  ...
  Usage:
    - e.g., Cb = flatsky.utils.c2d2bcl(nx,ny,D,c2d,bn,oL,spc)
  """
  if spc is None: spc=''
...
def cb2c2d(bn,bc,nx,ny,D,lmin,lmax,Cb,method=None):
  """
  Assign values of 1D angular power spectrum on to 2D grid with linear interpolation
  ...
  Usage:
    - e.g., C2d = flatsky.utils.cb2c2d(bn,bc,nx,ny,D,lmin,lmax,Cb,method)
  """
...
def rotation(nx,ny,rot,rtype):
  ...
  """
  return libflatsky.utils.rotation(nx,ny,rot,rtype)
