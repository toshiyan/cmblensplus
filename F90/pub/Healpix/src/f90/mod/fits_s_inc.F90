...
!    subroutine read_fits_partial_s     (4/8)
!    subroutine write_fits_partial_s     (4)
!
!
...
subroutine input_map8_s(filename, map, npixtot, nmaps, &
  ...
  use pix_tools, only: nside2npix
    ...
    real(SP),   dimension(:,:), allocatable :: iqu
    integer(I4B) :: status
...
!---------------------------------------
...
#ifndef NO64BITS
  !=======================================================================
  subroutine read_fits_partial4_s(filename, pixel, cutmap, header, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
    character(len=*),                     intent(in)            :: filename
    integer(I4B),     dimension(0:),      intent(out)           :: pixel
    real(SP),       dimension(0:,1:),   intent(out)           :: cutmap
    character(len=*), dimension(1:),      intent(out), optional :: header
    integer(I4B),                         intent(in),  optional :: extno
    !
    integer(i8b),     dimension(:), allocatable :: pixel8
    ...
    call read_fits_partial8_s(filename, pixel8, cutmap, header, extno)
  ...
  end subroutine read_fits_partial4_s
#endif
  !=======================================================================
  subroutine read_fits_partial8_s(filename, pixel, cutmap, header, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
    character(len=*),                     intent(in)            :: filename
...
!     endif
    ...
    return
  end subroutine read_fits_partial8_s
  ...
  !=======================================================================
  subroutine write_fits_partial4_s(filename, pixel, cutmap, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    character(len=*),                   intent(in)           :: filename
    integer(I4B),     dimension(0:),    intent(in)           :: pixel
    real(SP),       dimension(0:,1:), intent(in)           :: cutmap
    ...
    call sub_write_fits_partial_s(filename, cutmap, pixel4=pixel, &
         header=header, coord=coord, nside=nside, order=order, units=units, extno=extno)
  end subroutine write_fits_partial4_s
  !=======================================================================
#ifndef NO64BITS
  subroutine write_fits_partial8_s(filename, pixel, cutmap, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    character(len=*),                   intent(in)           :: filename
    ...
    integer(I4B),                       intent(in), optional :: extno !, polarisation
    character(len=*), parameter :: routine = 'write_fits_partial'
    call sub_write_fits_partial_s(filename, cutmap, pixel8=pixel, &
         header=header, coord=coord, nside=nside, order=order, units=units, extno=extno)
  end subroutine write_fits_partial8_s
#endif
  !=======================================================================
  subroutine sub_write_fits_partial_s(filename, cutmap, &
       &                     pixel4, pixel8, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
...
!     endif
    ...
    return
  end subroutine sub_write_fits_partial_s
