...
!    subroutine read_fits_partial_d     (4/8)
!    subroutine write_fits_partial_d     (4)
!
!
...
subroutine input_map8_d(filename, map, npixtot, nmaps, &
  ...
  use pix_tools, only: nside2npix
    ...
    real(DP),   dimension(:,:), allocatable :: iqu
    integer(I4B) :: status
...
!---------------------------------------
...
#ifndef NO64BITS
  !=======================================================================
  subroutine read_fits_partial4_d(filename, pixel, cutmap, header, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
    character(len=*),                     intent(in)            :: filename
    integer(I4B),     dimension(0:),      intent(out)           :: pixel
    real(DP),       dimension(0:,1:),   intent(out)           :: cutmap
    character(len=*), dimension(1:),      intent(out), optional :: header
    integer(I4B),                         intent(in),  optional :: extno
    !
    integer(i8b),     dimension(:), allocatable :: pixel8
    ...
    call read_fits_partial8_d(filename, pixel8, cutmap, header, extno)
  ...
  end subroutine read_fits_partial4_d
#endif
  !=======================================================================
  subroutine read_fits_partial8_d(filename, pixel, cutmap, header, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
    character(len=*),                     intent(in)            :: filename
...
!     endif
    ...
    return
  end subroutine read_fits_partial8_d
  ...
  !=======================================================================
  subroutine write_fits_partial4_d(filename, pixel, cutmap, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    character(len=*),                   intent(in)           :: filename
    integer(I4B),     dimension(0:),    intent(in)           :: pixel
    real(DP),       dimension(0:,1:), intent(in)           :: cutmap
    ...
    call sub_write_fits_partial_d(filename, cutmap, pixel4=pixel, &
         header=header, coord=coord, nside=nside, order=order, units=units, extno=extno)
  end subroutine write_fits_partial4_d
  !=======================================================================
#ifndef NO64BITS
  subroutine write_fits_partial8_d(filename, pixel, cutmap, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    character(len=*),                   intent(in)           :: filename
    ...
    integer(I4B),                       intent(in), optional :: extno !, polarisation
    character(len=*), parameter :: routine = 'write_fits_partial'
    call sub_write_fits_partial_d(filename, cutmap, pixel8=pixel, &
         header=header, coord=coord, nside=nside, order=order, units=units, extno=extno)
  end subroutine write_fits_partial8_d
#endif
  !=======================================================================
  subroutine sub_write_fits_partial_d(filename, cutmap, &
       &                     pixel4, pixel8, &
       &                     header, coord, nside, order, units, extno)
    !=======================================================================
    use long_intrinsic, only: long_size
...
!     endif
    ...
    return
  end subroutine sub_write_fits_partial_d
