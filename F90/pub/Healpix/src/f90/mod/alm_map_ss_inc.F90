...
!     * the sum over m is done by FFT
  !=======================================================================
  subroutine alm2map_sc_wrapper_s(nsmax, nlmax, nmmax, alm, map, zbounds,plm)
    !=======================================================================
    ...
    if (present(plm)) then
       if (present(zbounds)) then
          ...
          call alm2map_sc_pre_s(nsmax, nlmax, nmmax, alm, map, plm)
       endif
    else
       if (present(zbounds)) then
          call alm2map_sc_s(nsmax, nlmax, nmmax, alm, map, zbounds=zbounds)
       else
          call alm2map_sc_s(nsmax, nlmax, nmmax, alm, map)
       endif
    endif
    return
  end subroutine alm2map_sc_wrapper_s
  !=======================================================================
  subroutine alm2map_sc_s(nsmax, nlmax, nmmax, alm, map, zbounds)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    ...
    call sharp_hp_alm2map_x_s(nsmax,nlmax,nmmax,alm,map,zbounds_in)
#else
...
!$OMP end parallel
  ...
  !=======================================================================
  subroutine alm2map_spin_s(nsmax, nlmax, nmmax, spin, alm, map, zbounds)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    !      for the Temperature field
    !=======================================================================
...
!     endif
    ...
    if (aspin > 0) then
       ...
       call sharp_hp_alm2map_x_s(nsmax,nlmax,nmmax,&
...
!$OMP end parallel
  ...
  !=======================================================================
  subroutine alm2map_pol_wrapper_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, zbounds, plm)
    !=======================================================================
    !     gfortran gets confused between plm and zbounds
    !=======================================================================
    integer(I4B), intent(IN)                   :: nsmax, nlmax, nmmax
    ...
    if (present(plm)) then
       if (present(zbounds)) then
          ...
          call alm2map_pol_pre1_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, plm)
       endif
    else
       if (present(zbounds)) then
          call alm2map_pol_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, zbounds=zbounds)
       else
          call alm2map_pol_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU)
       endif
    endif
    return
  end subroutine alm2map_pol_wrapper_s

  !=======================================================================
  subroutine alm2map_pol_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, zbounds)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    ...
    call sharp_hp_alm2map_pol_x_s(nsmax,nlmax,nmmax,alm_TGC,map_TQU,zbounds_in)
#else
...
!$OMP end parallel
  ...
  !=======================================================================
  subroutine alm2map_sc_der_s(nsmax, nlmax, nmmax, alm, map, der1, der2, zbounds)
    !=======================================================================
...
!$OMP end parallel
  ...
  !=======================================================================
  subroutine alm2map_pol_der_s(nsmax, nlmax, nmmax, alm_TGC, map_TQU, der1, der2, zbounds)
    !=======================================================================
    !     computes a map and its 1st and 2nd derivative
    !       from its alm for the HEALPIX pixelisation
...
!     endif
    ...
    if (aspin > 0) then
       ...
       call sharp_hp_map2alm_x_s(nsmax,nlmax,nmmax, &
...
!$OMP end parallel
  ...
  !=======================================================================
  subroutine map2alm_iterative_old_s(nsmax, nlmax, nmmax, iter_order, map_TQU, alm_TGC, &
...
9111   format(i3,3(g20.5))
    ...
    return
  end subroutine map2alm_iterative_old_s
