...
def qtt(lmax,rlmin,rlmax,fC,Tlm1,Tlm2,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qtt(lmax,rlmin,rlmax,fC,Tlm1,Tlm2,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qtt(lmax,rlmin,rlmax,fC,Tlm1,Tlm2,nside,gtype,verbose)

def qte(lmax,rlmin,rlmax,fC,Tlm,Elm,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qte(lmax,rlmin,rlmax,fC,Tlm,Elm,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qte(lmax,rlmin,rlmax,fC,Tlm,Elm,nside,gtype,verbose)

def qtb(lmax,rlmin,rlmax,fC,Tlm,Blm,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qtb(lmax,rlmin,rlmax,fC,Tlm,Blm,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qtb(lmax,rlmin,rlmax,fC,Tlm,Blm,nside,gtype,verbose)

def qee(lmax,rlmin,rlmax,fC,Elm1,Elm2,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qee(lmax,rlmin,rlmax,fC,Elm1,Elm2,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qee(lmax,rlmin,rlmax,fC,Elm1,Elm2,nside,gtype,verbose)

def qeb(lmax,rlmin,rlmax,fC,Elm,Blm,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qeb(lmax,rlmin,rlmax,fC,Elm,Blm,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qeb(lmax,rlmin,rlmax,fC,Elm,Blm,nside,gtype,verbose)

def qbb(lmax,rlmin,rlmax,fC,Blm1,Blm2,nside=0,gtype='',verbose=False):
  """
  ...
  Usage:
    :glm,clm = curvedsky.rec_lens.qbb(lmax,rlmin,rlmax,fC,Blm1,Blm2,nside,gtype,verbose):
  """
  return libcurvedsky.rec_lens.qbb(lmax,rlmin,rlmax,fC,Blm1,Blm2,nside,gtype,verbose)
