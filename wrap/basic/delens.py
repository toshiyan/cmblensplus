...
def resbb(lmax,dlmin,dlmax,CE,Cp,WE,Wp):
  ...
  Usage:
    :lmax,CB = basic.delens.resbb(lmax,dlmin,dlmax,CE,Cp,WE,Wp):
  """
...
def lintemplate(lmax,dlmin,dlmax,CE,Cp,WE,Wp):
  """
  Usage:
    :lmax,Cl = basic.delens.lintemplate(lmax,dlmin,dlmax,CE,Cp,WE,Wp):
  """
...
def lensingbb(lmax,dlmin,dlmax,CE,Cp):
  """
  Usage:
    :lmax,CB = basic.delens.lensingbb(lmax,dlmin,dlmax,CE,Cp):
  """
...
def delensbias_dom(lmax,dlmin,dlmax,EE,BB,pp,NP1,NP2,Ag,DBl):
  """
  Usage:
    :lmax = basic.delens.delensbias_dom(lmax,dlmin,dlmax,EE,BB,pp,NP1,NP2,Ag,DBl):
  """
